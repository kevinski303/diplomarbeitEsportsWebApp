...
class GamesController extends Controller
{
    ...
    public function create()
    {
        ...
        $tournaments = \App\Tournament::get()->pluck('name', 'id')->prepend(trans('quickadmin.qa_please_select'), '');
        ...
        return view('admin.games.create', compact('tournaments', 'team1s', 'team2s'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.games.edit', compact('game', 'tournaments', 'team1s', 'team2s'));
    }

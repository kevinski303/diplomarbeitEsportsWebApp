...
class TeamsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $games = \App\Game::where('team1_id', $id)->get();$games = \App\Game::where('team2_id', $id)->get();$tournaments = \App\Tournament::where('winner_id', $id)->get();

        $team = Team::findOrFail($id);

        return view('admin.teams.show', compact('team', 'games', 'games', 'tournaments'));
    }
